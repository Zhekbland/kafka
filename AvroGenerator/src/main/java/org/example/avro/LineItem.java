...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1075163959054342220L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LineItem\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"ItemCode\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"ItemDescription\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"ItemPrice\",\"type\":[\"null\",\"double\"]},{\"name\":\"ItemQty\",\"type\":[\"null\",\"int\"]},{\"name\":\"TotalValue\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public static org.example.avro.LineItem.Builder newBuilder() {
    return new org.example.avro.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static org.example.avro.LineItem.Builder newBuilder(org.example.avro.LineItem.Builder other) {
    if (other == null) {
      return new org.example.avro.LineItem.Builder();
    } else {
      return new org.example.avro.LineItem.Builder(other);
    }
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static org.example.avro.LineItem.Builder newBuilder(org.example.avro.LineItem other) {
    if (other == null) {
      return new org.example.avro.LineItem.Builder();
    } else {
      return new org.example.avro.LineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.LineItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.ItemCode)) {
        this.ItemCode = data().deepCopy(fields()[0].schema(), other.ItemCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder setItemCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder clearItemCode() {
      ItemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder setItemDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder clearItemPrice() {
      ItemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder clearItemQty() {
      ItemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder setTotalValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.LineItem.Builder clearTotalValue() {
      TotalValue = null;
